...
Script to output usage of wg vpn server members compared to each other and how much they should pay for their vpn usage.
It is possible to anonymize nicknames of users.
